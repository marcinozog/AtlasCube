...
static const ui_profile_t k_defaults = {
    ...
    .clock_strip_title_font    = &lv_font_montserrat_12_pl,
    .clock_time_x              = 30,  // Centering depends on the font, here a slight offset
    .clock_time_y              = 45,
    ...
    .clock_netinfo_x           = 18,    // single line, full width; first-cut, tune in editor
    .clock_netinfo_y           = 158,
...
static const ui_profile_t k_defaults = {
    ...
    .clock_show_date           = true,
    .clock_show_netinfo        = true,
    .clock_netinfo_x           = 50,   // single line; first-cut, tune in editor
    .clock_netinfo_y           = 150,
    .clock_netinfo_font        = &lv_font_montserrat_12_pl,
    .clock_show_strip          = true,
    .clock_show_mode_indicator = true,
