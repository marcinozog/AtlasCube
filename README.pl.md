...
- Widget pogody — opcjonalna bieżąca temperatura i warunki na ekranie głównym, z ikonami zależnymi od pogody oraz dnia/nocy; do wyboru Open-Meteo bez klucza lub OpenWeatherMap (wymaga klucza API), ze współrzędnymi, jednostką (Celsjusz/Fahrenheit) i interwałem odświeżania ustawianymi w Ustawienia → Pogoda
...
| `AtlasCube-st7789v-xpt2046.bin` | ST7789V 320×240 (SPI) | XPT2046 (rezystancyjny) — eksperymentalny |
...
- [`wallpapers.md`](docs/wallpapers.md) — jak wgrać tapetę na ekran: galeria online, sloty internetowe, pliki z SD
