...
void now_playing_widget_create(lv_obj_t *parent)
{
    ...
    lv_obj_set_width(s_label_station, 300);
    ...
    lv_obj_align(s_label_title, LV_ALIGN_TOP_MID, 0, 36);
