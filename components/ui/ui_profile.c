...
static const ui_profile_t k_defaults = {
    ...
    .radio_state_y             = 44,
    .radio_state_font          = &lv_font_montserrat_12_pl,
    .radio_audio_info_x        = 6,
    .radio_audio_info_y        = 50,
    .radio_audio_info_font     = &lv_font_montserrat_12_pl,
    .radio_show_mode_indicator = false,
    .radio_show_clock          = false,
    .radio_show_event_indicator = false,
    ...
    .settings_hint_y           = -1,
    // header + footer in compact ASCII montserrat_8; rows stay _12_pl (readable)
    .settings_title_font       = &lv_font_montserrat_8,
    .settings_row_font         = &lv_font_montserrat_12_pl,
    .settings_value_font       = &lv_font_montserrat_12_pl,
    .settings_hint_font        = &lv_font_montserrat_8,
...
static const ui_profile_t k_defaults = {
    ...
    .clock_strip_title_font    = &lv_font_montserrat_12_pl,
    .clock_time_x              = 40,  // Centering depends on the font, here a slight offset
    .clock_time_y              = 45,
    ...
    .radio_audio_info_x        = 20,
    .radio_audio_info_y        = 233,
    .radio_audio_info_font     = &lv_font_montserrat_12_pl,
...
static const ui_profile_t k_defaults = {
    ...
    .radio_state_x             = 190,
    .radio_state_y             = 278,
    .radio_state_font          = &lv_font_montserrat_18_pl,
    .radio_audio_info_x        = 110,
