...
static const editor_element_t RADIO_ELEMENTS[] = {
    ...
    { "Vol slider", "VOL", SHAPE_VU,
      OFF(radio_volslider_show), OFF(radio_volslider_x), OFF(radio_volslider_y),
      OFF(radio_volslider_w), OFF(radio_volslider_h), OFF_NONE, false, false },
