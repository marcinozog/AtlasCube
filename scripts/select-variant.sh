...
echo "Active defines:"
grep -E "^[[:space:]]*#define[[:space:]]+(DISPLAY_(ILI9341|ST7796|CO5300|SSD1322)|TOUCH_(FT6336U|CST816D)|UI_PROFILE_(240X296|320x240|480x320|MONO_128X64)|FLASH_(8MB|16MB))[[:space:]]*$" "${DEFINES}" \
    | sed 's/^/  /'
